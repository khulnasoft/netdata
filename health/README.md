...
community-configured alerts for every app/service [the Agent collects metrics from](https://github.com/khulnasoft/netdata/blob/master/collectors/COLLECTORS.md), or
silence anything you're not interested in. You can even power complex lookups by running statistical algorithms against
your metrics.

You can [use various alert notification methods](https://github.com/khulnasoft/netdata/edit/master/docs/monitor/enable-notifications.md), 
[customize alerts](https://github.com/khulnasoft/netdata/blob/master/health/REFERENCE.md), and 
[disable/silence](https://github.com/khulnasoft/netdata/blob/master/health/REFERENCE.md#disable-or-silence-alerts) alerts.
