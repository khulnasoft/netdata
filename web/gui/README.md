...
> ⚠️ You're checking the documentation for the legacy Agent dashboard. For the current version please check [Accessing Netdata Dashboards](https://github.com/khulnasoft/netdata/blob/master/docs/category-overview-pages/accessing-netdata-dashboards.md).
...
overview](https://github.com/khulnasoft/netdata/blob/master/web/README.md).
...
Netdata uses an [internal, static-threaded web server](https://github.com/khulnasoft/netdata/blob/master/web/server/README.md) to host the HTML, CSS, and JavaScript
files that make up the local Agent dashboard. You don't have to configure anything to access it, although you can adjust
[your settings](https://github.com/khulnasoft/netdata/blob/master/web/server/README.md#other-netdataconf-web-section-options) in the `netdata.conf` file, or run Netdata
behind an [Nginx proxy](https://github.com/khulnasoft/netdata/blob/master/docs/Running-behind-nginx.md), and so on.
...
broken down into [contexts](https://github.com/khulnasoft/netdata/blob/master/web/README.md#contexts) and
[families](https://github.com/khulnasoft/netdata/blob/master/web/README.md#families).
...
[Increase the metrics retention policy](https://github.com/khulnasoft/netdata/blob/master/docs/store/change-metrics-storage.md) for your node to see more historical
timeframes.
...
[families](https://github.com/khulnasoft/netdata/blob/master/web/README.md#families) from that section. Netdata automatically
...
For information on creating custom dashboards from scratch, see the [custom dashboards](https://github.com/khulnasoft/netdata/blob/master/web/gui/custom/README.md) or
[Atlassian Confluence dashboards](https://github.com/khulnasoft/netdata/blob/master/web/gui/confluence/README.md) guides.
