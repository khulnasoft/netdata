...
date: 2020-04-27
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/web/api/health/README.md
...
The `selection criteria` are key/value pairs, in the format `key : value`, where value is a Netdata [simple pattern](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md). This means that you can create very powerful selectors (you will rarely need more than one or two).
...
The test script under [tests/health_mgmtapi](https://github.com/khulnasoft/netdata/blob/master/tests/health_mgmtapi/README.md) contains a series of tests that you can either run or read through to understand the various calls and responses better.
