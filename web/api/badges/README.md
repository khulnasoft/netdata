...
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/web/api/badges/README.md
...
Let's see a few more badge examples (they come from the [Netdata registry](https://github.com/khulnasoft/netdata/blob/master/registry/README.md)):
