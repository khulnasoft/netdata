...
in an [alert configuration](https://github.com/khulnasoft/netdata/blob/master/health/REFERENCE.md).
...
The engine does not evaluate dimensions that do not match the [simple pattern](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md)
