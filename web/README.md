...
1.  The [local Agent dashboard](https://github.com/khulnasoft/netdata/blob/master/web/gui/README.md) that comes pre-configured with every Netdata installation. You can
    ...
    JavaScript](https://github.com/khulnasoft/netdata/blob/master/web/gui/README.md#customizing-the-local-dashboard).

2.  The [`dashboard.js` JavaScript library](#dashboardjs), which helps you
   [customize the standard dashboards](https://github.com/khulnasoft/netdata/blob/master/web/gui/README.md#customizing-the-local-dashboard)
   using JavaScript, or create entirely new [custom dashboards](https://github.com/khulnasoft/netdata/blob/master/web/gui/custom/README.md) or
   [Atlassian Confluence dashboards](https://github.com/khulnasoft/netdata/blob/master/web/gui/confluence/README.md).

You can also view all the data Netdata collects through the [REST API v1](https://github.com/khulnasoft/netdata/blob/master/web/api/README.md#netdata-rest-api).
...
The [custom dashboards documentation](https://github.com/khulnasoft/netdata/blob/master/web/gui/custom/README.md) contains examples of such
custom HTML pages.
