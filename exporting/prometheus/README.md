...
Netdata supports exporting metrics to Prometheus in two ways:
 ...
 - You can [configure Netdata to push metrics to Prometheus](https://github.com/khulnasoft/netdata/blob/master/exporting/prometheus/remote_write/README.md)
...
of [simple patterns](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md) to match the
