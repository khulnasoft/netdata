...
custom_edit_url: "https://github.com/khulnasoft/netdata/edit/master/exporting/README.md"
...
databases](https://github.com/khulnasoft/netdata/blob/master/docs/export/external-databases.md), or jump in to [enabling a connector](https://github.com/khulnasoft/netdata/blob/master/docs/export/enable-connector.md).
...
restart its process_, not the entire [database of long-term metrics](https://github.com/khulnasoft/netdata/blob/master/docs/store/change-metrics-storage.md).
...
[list of supported databases](https://github.com/khulnasoft/netdata/blob/master/docs/export/external-databases.md#supported-databases) for information on which
connector to enable and configure for your database of choice.

-   [**AWS Kinesis Data Streams**](https://github.com/khulnasoft/netdata/blob/master/exporting/aws_kinesis/README.md): Metrics are sent to the service in `JSON`
    format.
-   [**Google Cloud Pub/Sub Service**](https://github.com/khulnasoft/netdata/blob/master/exporting/pubsub/README.md): Metrics are sent to the service in `JSON`
    format.
-   [**Graphite**](https://github.com/khulnasoft/netdata/blob/master/exporting/graphite/README.md): A plaintext interface. Metrics are sent to the database server as
    ...
    Graphite](https://github.com/khulnasoft/netdata/blob/master/exporting/graphite/README.md).
-   [**JSON** document databases](https://github.com/khulnasoft/netdata/blob/master/exporting/json/README.md)
-   [**OpenTSDB**](https://github.com/khulnasoft/netdata/blob/master/exporting/opentsdb/README.md): Use a plaintext or HTTP interfaces. Metrics are sent to
    OpenTSDB as `prefix.chart.dimension` with tag `host=hostname`.
-   [**MongoDB**](https://github.com/khulnasoft/netdata/blob/master/exporting/mongodb/README.md): Metrics are sent to the database in `JSON` format.
-   [**Prometheus**](https://github.com/khulnasoft/netdata/blob/master/exporting/prometheus/README.md): Use an existing Prometheus installation to scrape metrics
    from node using the Netdata API.
-   [**Prometheus remote write**](https://github.com/khulnasoft/netdata/blob/master/exporting/prometheus/remote_write/README.md). A binary snappy-compressed protocol
    buffer encoding over HTTP. Supports many [storage
    providers](https://prometheus.io/docs/operating/integrations/#remote-endpoints-and-storage).
-   [**TimescaleDB**](https://github.com/khulnasoft/netdata/blob/master/exporting/TIMESCALE.md): Use a community-built connector that takes JSON streams from a
