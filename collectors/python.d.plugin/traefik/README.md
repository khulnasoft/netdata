...
custom_edit_url: "https://github.com/khulnasoft/netdata/edit/master/collectors/python.d.plugin/traefik/README.md"
...
Netdata [config directory](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md), which is typically
at `/etc/netdata`.
