...
custom_edit_url: "https://github.com/khulnasoft/netdata/edit/master/collectors/statsd.plugin/README.md"
...
- [K6 load testing tool](https://k6.io)
  ...
  - [Documentation](https://github.com/khulnasoft/netdata/blob/master/collectors/statsd.plugin/k6.md)
  - [Configuration](https://github.com/khulnasoft/netdata/blob/master/collectors/statsd.plugin/k6.conf)
- [Asterisk](https://www.asterisk.org/)
  - **Description:** Asterisk is an Open Source PBX and telephony toolkit.
  - [Documentation](https://github.com/khulnasoft/netdata/blob/master/collectors/statsd.plugin/asterisk.md)
  - [Configuration](https://github.com/khulnasoft/netdata/blob/master/collectors/statsd.plugin/asterisk.conf)
...
Private charts are controlled with `create private charts for metrics matching = *`. This setting accepts a space-separated list of [simple patterns](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md). Netdata will create private charts for all metrics **by default**.
...
You can specify Netdata StatsD to have a different `memory mode` than the rest of the Netdata Agent. You can read more about `memory mode` in the [documentation](https://github.com/khulnasoft/netdata/blob/master/database/README.md).
...
> You can read more about how the Netdata Agent organizes information in the relevant [documentation](https://github.com/khulnasoft/netdata/blob/master/web/README.md)
...
-   `metrics` is a Netdata [simple pattern](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md). This pattern should match all the possible StatsD metrics that will be participating in the application `myapp`.
...
- Create a configuration file for your app using [edit-config](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md): `sudo ./edit-config
  statsd.d/myapp.conf`
...
- A node with the [Netdata](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/README.md) installed.
...
Use [`edit-config`](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md#use-edit-config-to-edit-configuration-files) 
...
Find more details about family and context in our [documentation](https://github.com/khulnasoft/netdata/blob/master/web/README.md#families).
...
- **pattern**: A keyword that tells the StatsD server the `METRIC` string is actually a 
  [simple pattern](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md). 
  ...
  patterns in [dimension patterns](https://github.com/khulnasoft/netdata/blob/master/collectors/statsd.plugin/README.md#dimension-patterns).
...
To enable this StatsD configuration, [restart Netdata](https://github.com/khulnasoft/netdata/blob/master/docs/configure/start-stop-restart.md).
...
To edit the section, please follow the Netdata [documentation](https://github.com/khulnasoft/netdata/blob/master/web/gui/README.md#customizing-the-local-dashboard).
