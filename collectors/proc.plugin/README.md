...
> [!NOTE]  
> Temperature, fan speed, voltage and power metrics for AMD GPUs can be monitored using the [Sensors](https://github.com/khulnasoft/netdata/blob/master/collectors/charts.d.plugin/sensors/README.md) plugin.
