...
Learn more
about [how collectors work](https://github.com/khulnasoft/netdata/blob/master/collectors/README.md), and
then learn how to [enable or
configure](https://github.com/khulnasoft/netdata/blob/master/collectors/REFERENCE.md#enable-and-disable-a-specific-collection-module) any of the below collectors using the same process.
...
explicitly [disable the Go version](https://github.com/khulnasoft/netdata/blob/master/collectors/REFERENCE.md#enable-and-disable-a-specific-collection-module),
...
- If your application is instrumented to expose [StatsD](https://blog.netdata.cloud/introduction-to-statsd/) metrics,
  see our [generic StatsD collector](https://github.com/khulnasoft/netdata/blob/master/collectors/statsd.plugin/README.md).

- If you have data in CSV, JSON, XML or other popular formats, you may be able to use our
  [generic structured data (Pandas) collector](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/pandas/README.md),

- Check out our [GitHub issues](https://github.com/khulnasoft/netdata/issues). Use the search bar to look for previous
...
- If you don't see the collector there, you can make
  a [feature request](https://github.com/khulnasoft/netdata/issues/new/choose) on GitHub.
...
- If you have basic software development skills, you can add your own plugin
  ...
  or [Python](https://github.com/khulnasoft/netdata/blob/master/docs/guides/python-collector.md)
...
- [Go applications (EXPVAR)](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/go_expvar/integrations/go_applications_expvar.md)
...
- [Fail2ban](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/fail2ban/integrations/fail2ban.md)
...
- [OpenLDAP](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/openldap/integrations/openldap.md)
...
- [Puppet](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/puppet/integrations/puppet.md)
...
- [Containers](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/containers.md)
...
- [LXC Containers](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/lxc_containers.md)

- [Libvirt Containers](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/libvirt_containers.md)
...
- [Proxmox Containers](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/proxmox_containers.md)
...
- [Virtual Machines](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/virtual_machines.md)

- [Xen XCP-ng](https://github.com/khulnasoft/netdata/blob/master/collectors/xenstat.plugin/integrations/xen_xcp-ng.md)

- [cAdvisor](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/cadvisor.md)

- [oVirt Containers](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/ovirt_containers.md)
...
- [Memcached](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/memcached/integrations/memcached.md)
...
- [Oracle DB](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/oracledb/integrations/oracle_db.md)
...
- [RethinkDB](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/rethinkdbs/integrations/rethinkdb.md)

- [RiakKV](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/riakkv/integrations/riakkv.md)
...
- [BOINC](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/boinc/integrations/boinc.md)

- [Gearman](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/gearman/integrations/gearman.md)
...
- [ISC Bind (RNDC)](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/bind_rndc/integrations/isc_bind_rndc.md)

- [ISC DHCP](https://github.com/netdata/go.d.plugin/blob/master/modules/isc_dhcpd/integrations/isc_dhcp.md)

- [Name Server Daemon](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/nsd/integrations/name_server_daemon.md)
...
- [eBPF Cachestat](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_cachestat.md)

- [eBPF DCstat](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_dcstat.md)

- [eBPF Disk](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_disk.md)

- [eBPF Filedescriptor](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_filedescriptor.md)

- [eBPF Filesystem](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_filesystem.md)

- [eBPF Hardirq](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_hardirq.md)

- [eBPF MDflush](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_mdflush.md)

- [eBPF Mount](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_mount.md)

- [eBPF OOMkill](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_oomkill.md)

- [eBPF Process](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_process.md)

- [eBPF Processes](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_processes.md)

- [eBPF SHM](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_shm.md)

- [eBPF SWAP](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_swap.md)

- [eBPF Socket](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_socket.md)

- [eBPF SoftIRQ](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_softirq.md)

- [eBPF Sync](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_sync.md)

- [eBPF VFS](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/integrations/ebpf_vfs.md)
...
- [dev.cpu.0.freq](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/dev.cpu.0.freq.md)

- [dev.cpu.temperature](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/dev.cpu.temperature.md)

- [devstat](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/devstat.md)

- [getifaddrs](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/getifaddrs.md)

- [getmntinfo](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/getmntinfo.md)

- [hw.intrcnt](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/hw.intrcnt.md)

- [ipfw](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/ipfw.md)

- [kern.cp_time](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/kern.cp_time.md)

- [kern.ipc.msq](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/kern.ipc.msq.md)

- [kern.ipc.sem](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/kern.ipc.sem.md)

- [kern.ipc.shm](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/kern.ipc.shm.md)

- [net.inet.icmp.stats](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.inet.icmp.stats.md)

- [net.inet.ip.stats](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.inet.ip.stats.md)

- [net.inet.tcp.states](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.inet.tcp.states.md)

- [net.inet.tcp.stats](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.inet.tcp.stats.md)

- [net.inet.udp.stats](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.inet.udp.stats.md)

- [net.inet6.icmp6.stats](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.inet6.icmp6.stats.md)

- [net.inet6.ip6.stats](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.inet6.ip6.stats.md)

- [net.isr](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/net.isr.md)

- [system.ram](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/system.ram.md)

- [uptime](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/uptime.md)

- [vm.loadavg](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.loadavg.md)

- [vm.stats.sys.v_intr](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.stats.sys.v_intr.md)

- [vm.stats.sys.v_soft](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.stats.sys.v_soft.md)

- [vm.stats.sys.v_swtch](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.stats.sys.v_swtch.md)

- [vm.stats.vm.v_pgfaults](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.stats.vm.v_pgfaults.md)

- [vm.stats.vm.v_swappgs](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.stats.vm.v_swappgs.md)

- [vm.swap_info](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.swap_info.md)

- [vm.vmtotal](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/vm.vmtotal.md)

- [zfs](https://github.com/khulnasoft/netdata/blob/master/collectors/freebsd.plugin/integrations/zfs.md)
...
- [SpigotMC](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/spigotmc/integrations/spigotmc.md)
...
- [Pandas](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/pandas/integrations/pandas.md)
...
- [1-Wire Sensors](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/w1sensor/integrations/1-wire_sensors.md)

- [AM2320](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/am2320/integrations/am2320.md)

- [AMD CPU & GPU](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/amd_cpu_&_gpu.md)

- [AMD GPU](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/amd_gpu.md)

- [ARM HWCPipe](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/arm_hwcpipe.md)

- [CUPS](https://github.com/khulnasoft/netdata/blob/master/collectors/cups.plugin/integrations/cups.md)

- [HDD temperature](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/hddtemp/integrations/hdd_temperature.md)
...
- [Intelligent Platform Management Interface (IPMI)](https://github.com/khulnasoft/netdata/blob/master/collectors/freeipmi.plugin/integrations/intelligent_platform_management_interface_ipmi.md)

- [Linux Sensors (lm-sensors)](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/sensors/integrations/linux_sensors_lm-sensors.md)

- [Linux Sensors (sysfs)](https://github.com/khulnasoft/netdata/blob/master/collectors/charts.d.plugin/sensors/integrations/linux_sensors_sysfs.md)
...
- [S.M.A.R.T.](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/smartd_log/integrations/s.m.a.r.t..md)
...
- [Kubernetes Containers](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/kubernetes_containers.md)

- [Rancher](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/rancher.md)

### Linux Systems

- [CPU performance](https://github.com/khulnasoft/netdata/blob/master/collectors/perf.plugin/integrations/cpu_performance.md)

- [Disk space](https://github.com/khulnasoft/netdata/blob/master/collectors/diskspace.plugin/integrations/disk_space.md)
...
- [Interrupts](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/interrupts.md)

- [SoftIRQ statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/softirq_statistics.md)

#### Disk

- [Disk Statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/disk_statistics.md)

- [MD RAID](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/md_raid.md)

##### BTRFS

- [BTRFS](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/btrfs.md)

##### NFS

- [NFS Client](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/nfs_client.md)

- [NFS Server](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/nfs_server.md)

##### ZFS

- [ZFS Adaptive Replacement Cache](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/zfs_adaptive_replacement_cache.md)

- [ZFS Pools](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/zfs_pools.md)

#### Firewall

- [Conntrack](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/conntrack.md)

- [Netfilter](https://github.com/khulnasoft/netdata/blob/master/collectors/nfacct.plugin/integrations/netfilter.md)

- [Synproxy](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/synproxy.md)

- [nftables](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/nftables.md)

#### IPC

- [Inter Process Communication](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/inter_process_communication.md)

#### Kernel

- [Linux kernel SLAB allocator statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/slabinfo.plugin/integrations/linux_kernel_slab_allocator_statistics.md)

- [Power Capping](https://github.com/khulnasoft/netdata/blob/master/collectors/debugfs.plugin/integrations/power_capping.md)

#### Memory

- [Kernel Same-Page Merging](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/kernel_same-page_merging.md)

- [Linux ZSwap](https://github.com/khulnasoft/netdata/blob/master/collectors/debugfs.plugin/integrations/linux_zswap.md)

- [Memory Statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/memory_statistics.md)

- [Memory Usage](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/memory_usage.md)

- [Memory modules (DIMMs)](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/memory_modules_dimms.md)

- [Non-Uniform Memory Access](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/non-uniform_memory_access.md)

- [Page types](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/page_types.md)

- [System Memory Fragmentation](https://github.com/khulnasoft/netdata/blob/master/collectors/debugfs.plugin/integrations/system_memory_fragmentation.md)

- [ZRAM](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/zram.md)

#### Network

- [Access Points](https://github.com/khulnasoft/netdata/blob/master/collectors/charts.d.plugin/ap/integrations/access_points.md)

- [IP Virtual Server](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/ip_virtual_server.md)

- [IPv6 Socket Statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/ipv6_socket_statistics.md)

- [InfiniBand](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/infiniband.md)

- [Network interfaces](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/network_interfaces.md)

- [Network statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/network_statistics.md)

- [SCTP Statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/sctp_statistics.md)

- [Socket statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/socket_statistics.md)

- [Softnet Statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/softnet_statistics.md)

- [Wireless network interfaces](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/wireless_network_interfaces.md)

- [tc QoS classes](https://github.com/khulnasoft/netdata/blob/master/collectors/tc.plugin/integrations/tc_qos_classes.md)

#### Power Supply

- [Power Supply](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/power_supply.md)

#### Pressure

- [Pressure Stall Information](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/pressure_stall_information.md)

#### System

- [Entropy](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/entropy.md)

- [System Load Average](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/system_load_average.md)

- [System Uptime](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/system_uptime.md)

- [System statistics](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/integrations/system_statistics.md)
...
- [macOS](https://github.com/khulnasoft/netdata/blob/master/collectors/macos.plugin/integrations/macos.md)

### Mail Servers

- [DMARC](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/dmarc.md)

- [Dovecot](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/dovecot/integrations/dovecot.md)

- [Exim](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/exim/integrations/exim.md)
...
- [Postfix](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/postfix/integrations/postfix.md)

### Media Services

- [Discourse](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/discourse.md)

- [Icecast](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/icecast/integrations/icecast.md)

- [OBS Studio](https://github.com/netdata/go.d.plugin/blob/master/modules/prometheus/integrations/obs_studio.md)

- [RetroShare](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/retroshare/integrations/retroshare.md)
...
- [Beanstalk](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/beanstalk/integrations/beanstalk.md)
...
- [Example collector](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/example/integrations/example_collector.md)
...
- [Netdata Agent alarms](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/alarms/integrations/netdata_agent_alarms.md)

- [python.d changefinder](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/changefinder/integrations/python.d_changefinder.md)

- [python.d zscores](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/zscores/integrations/python.d_zscores.md)

### Processes and System Services

- [Applications](https://github.com/khulnasoft/netdata/blob/master/collectors/apps.plugin/integrations/applications.md)

- [Supervisor](https://github.com/netdata/go.d.plugin/blob/master/modules/supervisord/integrations/supervisor.md)

- [User Groups](https://github.com/khulnasoft/netdata/blob/master/collectors/apps.plugin/integrations/user_groups.md)

- [Users](https://github.com/khulnasoft/netdata/blob/master/collectors/apps.plugin/integrations/users.md)
...
- [AdaptecRAID](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/adaptec_raid/integrations/adaptecraid.md)
...
- [Ceph](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/ceph/integrations/ceph.md)
...
- [HP Smart Storage Arrays](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/hpssa/integrations/hp_smart_storage_arrays.md)
...
- [IPFS](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/ipfs/integrations/ipfs.md)
...
- [MegaCLI](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/megacli/integrations/megacli.md)
...
- [Samba](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/samba/integrations/samba.md)
...
- [IOPing](https://github.com/khulnasoft/netdata/blob/master/collectors/ioping.plugin/integrations/ioping.md)

- [Idle OS Jitter](https://github.com/khulnasoft/netdata/blob/master/collectors/idlejitter.plugin/integrations/idle_os_jitter.md)

- [Monit](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/monit/integrations/monit.md)
...
- [Timex](https://github.com/khulnasoft/netdata/blob/master/collectors/timex.plugin/integrations/timex.md)

### Systemd

- [Systemd Services](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/integrations/systemd_services.md)
...
- [OpenSIPS](https://github.com/khulnasoft/netdata/blob/master/collectors/charts.d.plugin/opensips/integrations/opensips.md)

### UPS

- [APC UPS](https://github.com/khulnasoft/netdata/blob/master/collectors/charts.d.plugin/apcupsd/integrations/apc_ups.md)
...
- [Libreswan](https://github.com/khulnasoft/netdata/blob/master/collectors/charts.d.plugin/libreswan/integrations/libreswan.md)
...
- [Tor](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/tor/integrations/tor.md)
...
- [Litespeed](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/litespeed/integrations/litespeed.md)
...
- [Squid](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/squid/integrations/squid.md)

- [Tengine](https://github.com/netdata/go.d.plugin/blob/master/modules/tengine/integrations/tengine.md)

- [Tomcat](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/tomcat/integrations/tomcat.md)

- [Traefik](https://github.com/netdata/go.d.plugin/blob/master/modules/traefik/integrations/traefik.md)

- [Varnish](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/varnish/integrations/varnish.md)
...
- [uWSGI](https://github.com/khulnasoft/netdata/blob/master/collectors/python.d.plugin/uwsgi/integrations/uwsgi.md)
