...
custom_edit_url: "https://github.com/khulnasoft/netdata/edit/master/collectors/apps.plugin/README.md"
...
In addition, if the [eBPF collector](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md) is running, your dashboard will also show an
additional [list of charts](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md#integration-with-appsplugin) using low-level Linux
metrics.
...
[`ebpf.d.conf`](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md#configure-the-ebpf-collector) file to ensure the eBPF program is enabled.

Also see our [guide on troubleshooting apps with eBPF
metrics](https://github.com/khulnasoft/netdata/blob/master/docs/guides/troubleshoot/monitor-debug-applications-ebpf.md) for ideas on how to interpret these charts in a
few scenarios.
...
For more information about badges check [Generating Badges](https://github.com/khulnasoft/netdata/blob/master/web/api/badges/README.md)
