...
1. `dbengine`, (the default) data are in database files. The [Database Engine](https://github.com/khulnasoft/netdata/blob/master/database/engine/README.md) works like a
   ...
   details see [here](https://github.com/khulnasoft/netdata/blob/master/database/engine/README.md).
...
[Parent - Child](https://github.com/khulnasoft/netdata/blob/master/docs/metrics-storage-management/enable-streaming.md) setups at the children side and only when the
resource constraints are very strict.

So,

- On a single node setup, use `[db].mode = dbengine`.
- On a [Parent - Child](https://github.com/khulnasoft/netdata/blob/master/docs/metrics-storage-management/enable-streaming.md) setup, use `[db].mode = dbengine` on the
...
When having a [**parent - child**](https://github.com/khulnasoft/netdata/blob/master/docs/metrics-storage-management/enable-streaming.md) setup, the child (the
...
You can also disable [data collection plugins](https://github.com/khulnasoft/netdata/blob/master/collectors/README.md) that you don't need. Disabling such plugins will also
