...
While [panning through time and zooming in/out](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/interact-new-charts.md) from charts it is helpful when you're looking a recent history, or want to do granular troubleshooting, what if you want to see metrics from 6 hours ago? Or 6 days?
...
At any time, [configure the internal TSDB's storage capacity](https://github.com/khulnasoft/netdata/blob/master/docs/store/change-metrics-storage.md) to expand your
