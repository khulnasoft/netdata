...
> ### Disclaimer
>
> This document is only applicable to the v1 version of the dashboard and doesn't affect the [Netdata Dashboard](https://github.com/khulnasoft/netdata/blob/master/docs/category-overview-pages/accessing-netdata-dashboards.md).

While the [Netdata dashboard](https://github.com/khulnasoft/netdata/blob/master/web/gui/README.md) comes preconfigured with hundreds of charts and
...
[legend of dimensions](https://github.com/khulnasoft/netdata/blob/master/docs/dashboard/dimensions-contexts-families.md#dimension) _below_ charts. 
...
Save the file, then navigate to your [Netdata config directory](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md) to edit `netdata.conf`. Add
