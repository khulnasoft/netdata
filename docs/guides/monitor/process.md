...
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/docs/guides/monitor/process.md
...
- One or more Linux nodes running [Netdata](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/README.md)
- A general understanding of how
  to [configure the Netdata Agent](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md)
  using `edit-config`.
...
of [standard applications that we support via collectors](https://github.com/khulnasoft/netdata/blob/master/collectors/COLLECTORS.md),
...
[**`apps.plugin`**](https://github.com/khulnasoft/netdata/blob/master/collectors/apps.plugin/README.md) looks at the Linux
...
[**`ebpf.plugin`**](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md): Netdata's extended
...
These groups are then reflected as [dimensions](https://github.com/khulnasoft/netdata/blob/master/web/README.md#dimensions)
...
the [appropriate method](https://github.com/khulnasoft/netdata/blob/master/docs/configure/start-stop-restart.md) for your system, to start collecting utilization metrics
