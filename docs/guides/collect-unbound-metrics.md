...
date: 2020-03-31
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/docs/guides/collect-unbound-metrics.md
...
method](https://github.com/khulnasoft/netdata/blob/master/docs/configure/start-stop-restart.md) for your system. You should see Unbound metrics in your Netdata
dashboard!
...
issue](https://github.com/khulnasoft/netdata/issues/new?assignees=&labels=bug%2Cneeds+triage&template=BUG_REPORT.yml) with your
thoughts.
