...
If you use an outbound proxy, you need to [take some extra steps]( https://github.com/khulnasoft/netdata/blob/master/claim/README.md#connect-through-a-proxy).
...
The most common issue we have seen claiming nodes in Docker is [running on older hosts with seccomp enabled](https://github.com/khulnasoft/netdata/blob/master/claim/README.md#known-issues-on-older-hosts-with-seccomp-enabled).
...
> Read more about [Starting, Stopping and Restarting the Agent](https://github.com/khulnasoft/netdata/blob/master/docs/configure/start-stop-restart.md).
