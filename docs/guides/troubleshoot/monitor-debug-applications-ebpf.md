...
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/docs/guides/troubleshoot/monitor-debug-applications-ebpf.md
...
machine](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md) to help you see exactly how specific applications are interacting with the
...
[`apps.plugin`](https://github.com/khulnasoft/netdata/blob/master/collectors/apps.plugin/README.md). Once you edit this file and create a new group for the application
...
method](https://github.com/khulnasoft/netdata/blob/master/docs/configure/start-stop-restart.md) for your system, to begin seeing metrics for this particular
...
from](https://github.com/khulnasoft/netdata/blob/master/collectors/COLLECTORS.md).
...
The eBPF collector has [two possible modes](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md#ebpf-load-mode): `entry` and `return`. The default
...
See the [eBPF collector documentation](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md#integration-with-appsplugin) for the full list
...
You can also read how to [monitor your infrastructure with Netdata Cloud](https://github.com/khulnasoft/netdata/blob/master/docs/quickstart/infrastructure.md) to understand the key features that it has to offer.

Once you've added one or more nodes to a Space in Netdata Cloud, you can see aggregated eBPF metrics in the [Overview
dashboard](https://github.com/khulnasoft/netdata/blob/master/docs/visualize/overview-infrastructure.md) under the same **Applications** or **eBPF** sections that you
find on the local Agent dashboard. Or, [create new dashboards](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/dashboards.md) using eBPF metrics
...
team](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/manage/organize-your-infrastrucutre-invite-your-team.md#invite-your-team) and share your findings with others.
