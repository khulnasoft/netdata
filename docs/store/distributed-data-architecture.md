...
visualize your nodes' metrics. When you [look at charts in Netdata Cloud](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/interact-new-charts.md)
...
- **Performance**: Every query to a node's database takes only a few milliseconds to complete for responsiveness when
  ...
  like [Metric Correlations](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/insights/metric-correlations.md).
...
Read our document on changing [how long Netdata stores metrics](https://github.com/khulnasoft/netdata/blob/master/docs/store/change-metrics-storage.md) on your nodes for
details.

You can also stream between nodes using [streaming](https://github.com/khulnasoft/netdata/blob/master/streaming/README.md), allowing to replicate databases and create
...
TimescaleDB, and many others, see details on [integrating Netdata via exporting](https://github.com/khulnasoft/netdata/blob/master/docs/export/external-databases.md).
...
To enable certain features, such as [viewing active alerts](https://github.com/khulnasoft/netdata/blob/master/docs/monitor/view-active-alerts.md)
or [filtering by hostname](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/node-filter.md), Netdata Cloud does
