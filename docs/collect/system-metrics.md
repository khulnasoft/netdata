...
custom_edit_url: "https://github.com/khulnasoft/netdata/edit/master/docs/collect/system-metrics.md"
...
devices, and [containers](https://github.com/khulnasoft/netdata/blob/master/docs/collect/container-metrics.md) with zero configuration.
...
[**proc.plugin**](https://github.com/khulnasoft/netdata/blob/master/collectors/proc.plugin/README.md) gathers metrics from the `/proc` and `/sys` folders in Linux
...
[**cgroups.plugin**](https://github.com/khulnasoft/netdata/blob/master/collectors/cgroups.plugin/README.md) collects rich metrics about containers and virtual machines
...
[collecting container metrics](https://github.com/khulnasoft/netdata/blob/master/docs/collect/container-metrics.md) doc.

[**ebpf.plugin**](https://github.com/khulnasoft/netdata/blob/master/collectors/ebpf.plugin/README.md): Netdata's extended Berkeley Packet Filter (eBPF) collector
...
can find all system collectors in our [supported collectors list](https://github.com/khulnasoft/netdata/blob/master/collectors/COLLECTORS.md#system-collectors).
...
method](https://github.com/khulnasoft/netdata/blob/master/docs/configure/start-stop-restart.md) for your system. You'll start seeing Windows system metrics, such as CPU
...
doc](https://github.com/khulnasoft/netdata/blob/master/docs/collect/application-metrics.md#collect-metrics-from-applications-running-on-windows).

## What's next?

Because there's some overlap between system metrics and [container metrics](https://github.com/khulnasoft/netdata/blob/master/docs/collect/container-metrics.md), you
should investigate Netdata's container compatibility if you use them heavily in your infrastructure.

If you don't use containers, skip ahead to collecting [application metrics](https://github.com/khulnasoft/netdata/blob/master/docs/collect/application-metrics.md) with
Netdata.
