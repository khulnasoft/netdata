...
custom_edit_url: "https://github.com/khulnasoft/netdata/edit/master/docs/collect/application-metrics.md"
...
[**apps.plugin**](https://github.com/khulnasoft/netdata/blob/master/collectors/apps.plugin/README.md) looks at the Linux process tree every second, much like `top` or
...
Our [supported collectors list](https://github.com/khulnasoft/netdata/blob/master/collectors/COLLECTORS.md#service-and-application-collectors) shows all Netdata's
...
caveat is that you must [install Netdata](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/README.md) on a separate system or a compatible VM because there
is no native Windows version of the Netdata Agent.

Once you have Netdata running on that separate system, you can follow the [collectors configuration reference](https://github.com/khulnasoft/netdata/blob/master/collectors/REFERENCE.md) documentation to tell the collector to look for exposed metrics on the Windows system's IP
...
list](https://github.com/khulnasoft/netdata/blob/master/collectors/COLLECTORS.md#service-and-application-collectors) that can run on Windows.

## What's next?

If you haven't yet seen the [supported collectors list](https://github.com/khulnasoft/netdata/blob/master/collectors/COLLECTORS.md) give it a once-over for any
...
infrastructure](https://github.com/khulnasoft/netdata/blob/master/docs/visualize/overview-infrastructure.md) using Netdata Cloud.
