...
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/docs/anonymous-statistics.md
...
-   **Agent dashboard**: We use the [PostHog JavaScript integration](https://posthog.com/docs/integrations/js-integration) (with sensitive event attributes overwritten to be anonymized) to send product usage events when you access an [Agent's dashboard](https://github.com/khulnasoft/netdata/blob/master/docs/category-overview-pages/accessing-netdata-dashboards.md).
-   **Agent backend**: The `netdata` daemon executes the [`anonymous-statistics.sh`](https://github.com/khulnasoft/netdata/blob/6469cf92724644f5facf343e4bdd76ac0551a418/daemon/anonymous-statistics.sh.in) script when Netdata starts, stops cleanly, or fails.
...
-   Failures to connect to the Cloud in case the [connection process](https://github.com/khulnasoft/netdata/blob/master/claim/README.md) has been completed. This includes error codes
...
docs](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/README.md).** You can append this option during the initial installation or a manual
...
image](https://github.com/khulnasoft/netdata/blob/master/packaging/docker/README.md#create-a-new-netdata-agent-container) for the first time, this variable will disable
