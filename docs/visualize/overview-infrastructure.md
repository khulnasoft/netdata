...
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/docs/visualize/overview-infrastructure.md
...
[**Overview**](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/overview.md), which uses composite charts to display
...
doc](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/methods/kubernetes.md) for details on visualizing Kubernetes metrics in Netdata Cloud.
...
filtering](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/node-filter.md) and the [time &amp; date
picker](https://github.com/khulnasoft/netdata/blob/master/docs/dashboard/visualization-date-and-time-controls.md), to widen or narrow your infrastructure
monitoring focus.
...
See the [War Rooms](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/manage/organize-your-infrastrucutre-invite-your-team.md#netdata-cloud-war-rooms) docs for more details on both features.
...
Use [_group by node_](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/overview.md#group-by-dimension-or-node) to visualize
...
All of the familiar [interactions](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/interact-new-charts.md) are available, as is adding any chart
to a [new dashboard](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/dashboards.md).

## Nodes tab

You can also use the **Nodes tab** to monitor the health status and user-configurable key metrics from multiple nodes
in a War Room. Read the [Nodes tab documentation](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/visualize/nodes.md) for details.
