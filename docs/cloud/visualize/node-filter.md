...
| Group   | Description                                                                                                                                                                                                                                                                                                                                                                                                           |
|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Live    | Nodes that are currently online, collecting and streaming metrics to Cloud. Live nodes display raised [Alert](https://github.com/khulnasoft/netdata/blob/master/docs/monitor/view-active-alerts.md) counters, [Machine Learning](https://github.com/khulnasoft/netdata/blob/master/ml/README.md) availability, and [Functions](https://github.com/khulnasoft/netdata/blob/master/docs/cloud/netdata-functions.md) availability |
