...
custom_edit_url: "https://github.com/khulnasoft/netdata/edit/master/docs/Running-behind-h2o.md"
...
In case Netdata's web server has been [configured to use TLS](https://github.com/khulnasoft/netdata/blob/master/web/server/README.md#enabling-tls-support), it is
...
`allow connections from` accepts [Netdata simple patterns](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md) to match against
