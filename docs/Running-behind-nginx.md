...
`allow connections from` accepts [Netdata simple patterns](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md) to match against the
