...
([ACLK](https://github.com/khulnasoft/netdata/blob/master/aclk/README.md)) that
...
Save and close the editor, then [restart your Agent](https://github.com/khulnasoft/netdata/blob/master/docs/configure/start-stop-restart.md) 
...
> See the [configuration basics doc](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md) for details on how to find 
...
For `gvpe` we have developed a [simple provisioning tool](https://github.com/khulnasoft/netdata-demo-site/tree/master/gvpe) you 
...
[access lists](https://github.com/khulnasoft/netdata/blob/master/web/server/README.md#access-lists). This method also fully 
...
patterns](https://github.com/khulnasoft/netdata/blob/master/libnetdata/simple_pattern/README.md).
...
See the [web server](https://github.com/khulnasoft/netdata/blob/master/web/server/README.md#access-lists) docs for additional details
about access lists. You can take
access lists one step further by [enabling SSL](https://github.com/khulnasoft/netdata/blob/master/web/server/README.md#enabling-tls-support) to encrypt data from local
...
[lighthttpd](https://github.com/khulnasoft/netdata/blob/master/docs/Running-behind-lighttpd.md), 
[caddy](https://github.com/khulnasoft/netdata/blob/master/docs/Running-behind-caddy.md), and
[H2O](https://github.com/khulnasoft/netdata/blob/master/docs/Running-behind-h2o.md).
...
For more information see [Streaming and replication](https://github.com/khulnasoft/netdata/blob/master/docs/metrics-storage-management/enable-streaming.md).
