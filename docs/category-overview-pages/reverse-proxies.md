...
A dedicated web server also provides more robustness and capabilities than the Agent's [internal web server](https://github.com/khulnasoft/netdata/blob/master/web/README.md).
...
and [H2O](https://github.com/khulnasoft/netdata/blob/master/docs/Running-behind-h2o.md).
