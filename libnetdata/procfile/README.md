<!--
title: "PROCFILE"
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/libnetdata/procfile/README.md
...
-   calls `procfile_readall()` to read updated contents.
     ...
     For every file, a [BUFFER](https://github.com/khulnasoft/netdata/blob/master/libnetdata/buffer/README.md) is used that is automatically adjusted to fit the entire
