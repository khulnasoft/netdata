...
> troubleshoot an error during the installation process? See our [reinstallation doc](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/REINSTALL.md)
...
documentation](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/README.md#installs-on-hosts-without-ipv4-connectivity).

### If the kickstart script does not work

If the above command fails, you can [reinstall
Netdata](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/REINSTALL.md#one-line-installer-script-kickstartsh) to get the latest version. This
also preserves your [configuration](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md) in `netdata.conf` or other files just like updating
...
installation instructions](https://github.com/khulnasoft/netdata/blob/master/packaging/docker/README.md#create-a-new-netdata-agent-container) for details.
...
If you installed [Netdata manually from Git](https://github.com/khulnasoft/netdata/blob/master/packaging/installer/methods/manual.md), you can run that installer again
...
script](https://github.com/khulnasoft/netdata/blob/master/docs/configure/nodes.md).
