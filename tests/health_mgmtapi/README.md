...
custom_edit_url: https://github.com/khulnasoft/netdata/edit/master/tests/health_mgmtapi/README.md
...
The directory `tests/health_cmdapi` contains the test script `health-cmdapi-test.sh` for the [health command API](https://github.com/khulnasoft/netdata/blob/master/web/api/health/README.md).
